    ...
    if ($translations === null) {
        $translations = [
            'en' => [
                ...
                // Order Preparation
                'preparation.title' => 'Order Preparation',
                'preparation.back_to_orders' => 'Back to Orders',
                'preparation.summary' => 'Preparation Summary',
                'preparation.orders_to_prepare' => 'Orders to Prepare',
                'preparation.items_remaining' => 'Items Remaining',
                'preparation.items_prepared' => 'Items Prepared',
                'preparation.products_need_prep' => 'Products Need Prep',
                'preparation.view_shipping' => 'View Shipping',
                'preparation.ready_to_ship' => 'Ready to Ship',
                'preparation.all_caught_up' => 'All caught up!',
                'preparation.no_orders_waiting' => 'No orders are currently waiting for preparation.',
                'preparation.card' => 'Card',
                'preparation.collector_number' => 'Collector #',
                'preparation.rarity' => 'Rarity',
                'preparation.need_total' => 'Need / Total',
                'preparation.orders' => 'Orders',
                'preparation.unit_price' => 'Unit Price',
                'preparation.mark_prepared' => 'Mark Prepared',
                'preparation.order_ids' => 'Order IDs',
                'preparation.of' => 'of',
                'preparation.order_singular' => 'order',
                'preparation.order_plural' => 'orders',
                'preparation.instructions_title' => 'Preparation Instructions',
                'preparation.instructions_1' => 'Items are grouped by set for easier collection',
                'preparation.instructions_2' => 'Quantity shows total needed across all unprepared orders',
                'preparation.instructions_3' => 'Order IDs help you track which orders need each item',
                'preparation.instructions_4' => 'Once prepared, update individual order status to "Processing" or "Shipped" in the',
                'preparation.orders_management' => 'Orders Management',
                'preparation.mark_button' => 'Mark',

                // Order Shipping
                'shipping.title' => 'Order Shipping',
                'shipping.back_to_preparation' => 'Back to Preparation',
                'shipping.description' => 'Sort prepared items by individual orders for shipping',
                'shipping.no_items_prepared' => 'No items prepared yet',
                'shipping.prepare_items_first' => 'Prepare some items first in the',
                'shipping.order_preparation' => 'Order Preparation',
                'shipping.view' => 'view.',
                'shipping.orders_ready' => 'Orders Ready for Shipping',
                'shipping.pending_orders_info' => 'Pending orders with prepared items - fully prepared orders first.',
                'shipping.order' => 'Order',
                'shipping.customer' => 'Customer',
                'shipping.status' => 'Status',
                'shipping.prepared_items' => 'Prepared Items',
                'shipping.completion' => 'Completion',
                'shipping.total' => 'Total',
                'shipping.actions' => 'Actions',
                'shipping.items_prepared' => 'items prepared',
                'shipping.ready_to_ship' => 'Ready to ship',
                'shipping.show_items' => 'Show Items',
                'shipping.hide_items' => 'Hide Items',
                'shipping.mark_shipped' => 'Mark Shipped',
            ...
            'si' => [
                ...
                // Order Preparation
                'preparation.title' => 'Priprava naročil',
                'preparation.back_to_orders' => 'Nazaj na naročila',
                'preparation.summary' => 'Povzetek priprave',
                'preparation.orders_to_prepare' => 'Naročila za pripravo',
                'preparation.items_remaining' => 'Preostali artikli',
                'preparation.items_prepared' => 'Pripravljeni artikli',
                'preparation.products_need_prep' => 'Izdelki za pripravo',
                'preparation.view_shipping' => 'Poglej pošiljanje',
                'preparation.ready_to_ship' => 'Pripravljeno za pošiljanje',
                'preparation.all_caught_up' => 'Vse opravljeno!',
                'preparation.no_orders_waiting' => 'Nobeno naročilo trenutno ne čaka na pripravo.',
                'preparation.card' => 'Karta',
                'preparation.collector_number' => 'Zbirateljska št.',
                'preparation.rarity' => 'Redkost',
                'preparation.need_total' => 'Potrebno / Skupaj',
                'preparation.orders' => 'Naročila',
                'preparation.unit_price' => 'Cena na kos',
                'preparation.mark_prepared' => 'Označi kot pripravljeno',
                'preparation.order_ids' => 'ID-ji naročil',
                'preparation.of' => 'od',
                'preparation.order_singular' => 'naročilo',
                'preparation.order_plural' => 'naročil',
                'preparation.instructions_title' => 'Navodila za pripravo',
                'preparation.instructions_1' => 'Artikli so razvrščeni po setih za lažje zbiranje',
                'preparation.instructions_2' => 'Količina prikazuje skupno potrebo vseh nepripravljenih naročil',
                'preparation.instructions_3' => 'ID-ji naročil vam pomagajo slediti, katera naročila potrebujejo vsak artikel',
                'preparation.instructions_4' => 'Ko je pripravljeno, posodobite status posameznega naročila na "V obdelavi" ali "Poslano" na strani',
                'preparation.orders_management' => 'Upravljanje naročil',
                'preparation.mark_button' => 'Označi',

                // Order Shipping
                'shipping.title' => 'Pošiljanje naročil',
                'shipping.back_to_preparation' => 'Nazaj na pripravo',
                'shipping.description' => 'Razvrsti pripravljene artikle po posameznih naročilih za pošiljanje',
                'shipping.no_items_prepared' => 'Še ni pripravljenih artiklov',
                'shipping.prepare_items_first' => 'Najprej pripravite nekaj artiklov v',
                'shipping.order_preparation' => 'Priprava naročil',
                'shipping.view' => 'pogledu.',
                'shipping.orders_ready' => 'Naročila pripravljena za pošiljanje',
                'shipping.pending_orders_info' => 'Čakajoča naročila s pripravljenimi artikli - najprej popolnoma pripravljena naročila.',
                'shipping.order' => 'Naročilo',
                'shipping.customer' => 'Stranka',
                'shipping.status' => 'Status',
                'shipping.prepared_items' => 'Pripravljeni artikli',
                'shipping.completion' => 'Dokončanost',
                'shipping.total' => 'Skupaj',
                'shipping.actions' => 'Dejanja',
                'shipping.items_prepared' => 'artiklov pripravljenih',
                'shipping.ready_to_ship' => 'Pripravljeno za pošiljanje',
                'shipping.show_items' => 'Prikaži artikle',
                'shipping.hide_items' => 'Skrij artikle',
                'shipping.mark_shipped' => 'Označi kot poslano',
                'shipping.tracking_number' => 'Sledilna št.',
            ]
        ];
    }
